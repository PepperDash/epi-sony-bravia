...
namespace Pepperdash.Essentials.Plugins.SonyBravia
{
    public static class Rs232Commands
    {
        ...
        public static readonly byte[] PictureModeGame = { 0x8C, 0x00, 0x20, 0x03, 0x01, 0x08 };
        public static readonly byte[] PictureModeGraphics = { 0x8C, 0x00, 0x20, 0x03, 0x01, 0x09 };
        public static readonly byte[] PictureModeToggle = { 0x8C, 0x00, 0x20, 0x02, 0x00 };
        // not documented on Sony site
